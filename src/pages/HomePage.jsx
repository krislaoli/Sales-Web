  ...
  return (
    <div className="homepage">
          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              <h1 className="mb-4 animate__animated animate__lightSpeedInLeft animate__delay-1s">
                Semuanya <br /> <span>Tersedia Disini</span> <br /> Untuk
                AI
              </h1>
              ...
              <button className="btn  btn-lg rounded-1 me-2 mb-xs-0 mb-2 fw-bold animate__animated animate__zoomIn animate__delay-1s" style={{ backgroundColor: "#79AC78" }} onClick={() => navigate("/kelas")}>
                Lihat Kelas
              </button>
              <button className="btn btn-lg rounded-1 mb-xs-0 mb-2 fw-bold animate__animated animate__zoomIn animate__delay-1s" style={{ backgroundColor: "#FFC436" }}>
                Lihat Promo
              </button>
            </Col>
        ...
        <Container>
          ...
          <Row>
            <Col className="text-center" >
              <button
                className="btn fw-bold rounded-3 btn-lg" data-aos="fade-right" date-aos-duration="1000" style={{ backgroundColor: "#79AC78" }}
      ...
      <div className="testimonial py-5">
        <Container>
          <Row>
            <h1 className="text-center fw-bold my-3" data-aos="fade-up" date-aos-duration="1000">Testimonial</h1>
          </Row>
          <Row>
            <Swiper
              slidesPerView={1}
              ...
              pagination={{
                clickable: true,
              }}  data-aos="fade-up" date-aos-duration="1000"
              breakpoints={{
                640: {
                  slidesPerView: 1,
                  spaceBetween: 20,
